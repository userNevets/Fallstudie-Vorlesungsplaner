...
public class UniplanerApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		if(lectureRepository.count() ==0){
			...
			lecture1.setLecture_id(1L);
			lecture2.setLecture_id(2L);
			lecture3.setLecture_id(3L);
			lecture1.setCourse(courseRepository.findByid(1L));
			lecture2.setCourse(courseRepository.findByid(2L));
			lecture3.setCourse(courseRepository.findByid(3L));
